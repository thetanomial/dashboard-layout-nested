...
import { createBrowserRouter, Outlet, RouterProvider, NavLink, useLocation, useNavigate, Navigate } from 'react-router-dom';
...
const Dashboard = () => {
  ...
  return (
    <div>
      ...
      <section className="subnav-section">
        {location.pathname.startsWith('/dashboard/services/social_media') && <SocialMediaSubNav />}
        {location.pathname.startsWith('/dashboard/services') && !location.pathname.startsWith('/dashboard/services/social_media') && <ServicesSubNav />}
